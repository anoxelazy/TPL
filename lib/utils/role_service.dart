...
class RoleService {
  ...
  /// รหัสพนักงานของคนที่ล็อกอินอยู่ ว่างเมื่อยังไม่ได้ล็อกอิน
  ///
  /// ระบบแจ้งซ่อมกับ chatbot ใช้เลขนี้ผูกใบแจ้งซ่อมกับคนแจ้ง ไม่ใช่ชื่อ
  /// เพราะชื่อพิมพ์ไม่เหมือนกันในแต่ละครั้งแล้วค้นไม่เจอ
  String? get empId => _empId;

  /// เลขเดียวกับ [empId] แต่เป็นตัวเลข API ฝั่ง Supabase รับเป็น int
  int? get empNumber => int.tryParse(_empId ?? '');
