...
///
/// ยืนยันกับทีม backend แล้วว่าเป็นผู้ใช้ชุดเดียวกับ TPS และ token ใช้ร่วมกัน
/// ได้ทั้งสองฝั่ง (เดิมตรงนี้เขียนไว้ว่าเป็นข้อสมมติที่ยังไม่ได้ยืนยัน)
///
/// ยังเก็บ token แยก key กันอยู่ เพราะคนละระบบคนละอายุ ปนกันแล้วจะ debug
/// ไม่ออกว่าตัวไหนหมดอายุ ไม่ใช่เพราะเป็นคนละ token
class MobileSession {
  MobileSession._();
