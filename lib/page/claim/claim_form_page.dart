...
class ClaimFormPage extends StatefulWidget {
  ...
  final String empId;
  final Future<String?> Function(BuildContext, TextEditingController) onScanBarcode;
...
class _ClaimFormPageState extends State<ClaimFormPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool shouldShowFrontStoreOption = frontStoreEmployeeIds.contains(widget.empId);
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(widget.initialClaim == null ? 'สร้าง/แก้ไข' : 'แก้ไขรายการ'),
        ),
